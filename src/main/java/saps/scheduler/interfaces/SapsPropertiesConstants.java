...
public class SapsPropertiesConstants {
	  ...
	  public static final String PERMANENT_STORAGE_DEBUG_TASKS_DIR =
	      "permanent_storage_debug_tasks_dir";
	  ...
	  public static final String SAPS_EXECUTION_PERIOD_GARBAGE_COLLECTOR =
	      "saps_execution_period_garbage_collector";
